      ...
      **************************************************************************
      ...
      -              "txt/check_dossier_requete.txt"
           organization is line sequential.

           select F-Response
           assign to "/home/thomas/dev/projet_git/cobol-stage1/api/data_
      -              "txt/check_dossier_response.txt"
      ...
      ******************************************************************
      ...
      -         "PAS"
       ...
       Select-Dossier-Data.
           perform Select-Dossier-Data-Init.
           perform Select-Dossier-Data-Trt.
           perform Select-Dossier-Data-Fin.


       Select-Dossier-Data-Init.
           perform Initialisation-connexion-BDD.
           perform Connexion-BDD.
           MOVE 0 TO SQLCODE.
           MOVE LOW-VALUES TO SQLCA-STATEMENT.
           perform Generate-Select-Dossier-SQLCA-STATEMENT.
       Select-Dossier-Data-Trt.
           CALL 'MySQL_query' USING SQLCA-STATEMENT
...
DBPRE              END-IF
                   CALL 'MySQL_fetch_row' USING SQLCA-RESULT (1)
                                            IdDos of Dossier
                                            TypeSinistre of Dossier
                                            MontantGarantie of Dossier
...
DBPRE              END-IF
                   ...
                   WHEN DB-OK
                       STRING ',"' DELIMITED SIZE 
                           ...
                           '"' DELIMITED SIZE
                           IdDos of Dossier DELIMITED SIZE
                           '"' DELIMITED SIZE
                           ',' DELIMITED SIZE
                           '"TypeSinistre" : ' DELIMITED SIZE
                           '"' DELIMITED SIZE
                           TypeSinistre of Dossier DELIMITED SIZE
                           '"' DELIMITED SIZE
                           ',' DELIMITED SIZE
                           '"montantGarantie" : ' DELIMITED SIZE
                           '"' DELIMITED SIZE
                           MontantGarantie of Dossier DELIMITED SIZE
                           '"' DELIMITED SIZE
                           '}' DELIMITED SIZE
       ...
       Select-Dossier-Data-Fin.
           perform Close-BDD.
           EXIT.

       Write-Response-File.
           open output F-Response.
           MOVE LOW-VALUE TO DATA-RESPONSE.
           MOVE LOW-VALUE TO COMPLETE-RESPONSE.
           if CheckCorrespond equal 0 then
               STRING '{' DELIMITED SIZE
      ...
      ******************************************************************
       ...
       Initialisation-connexion-BDD-Init.
           MOVE 'CHECKDOS' TO PGCTB-PROGRAM-NAME.
